	...
	return function(t) {
		...
		function p(t, e, i) {
			if (t && e)
				...
				for (var n = 0, a = t.length; a > n; n++) e.call(i, t[n], n, t);
			else
		...
		function a(t, e) {
			if (t && (t.trigger(e), "group" === t.type))
				for (var i = 0; i < t.childCount(); i++) a(t.childAt(i), e)
		}
			...
			l = o.extend({
				...
				getTicks: function() {
					...
					if (t) {
						...
						e[0] < o[0] && i.push(e[0]);
						for (var r = o[0]; r <= o[1];)
							if (i.push(r), r = n.round(r + t), i.length > a) return [];
						e[1] > o[1] && i.push(e[1])
					}
					return i
				},
					...
					t && c(function(e) {
						if (t) {
							...
							if (a.length && !n.length)
								for (var o = 0, r = a.length; r > o; o++) "category" === a[o].get("type") && n.push(o);
		...
		u._updateCommon = function(t, e, i) {
			...
			for (var x, _ = s.getModel(f), w = s.getModel(p), b = a.style, M = t.dimensions.slice(), S = M.pop();
				"ordinal" === (x = t.getDimensionInfo(S).type) || "time" === x;) S = M.pop();
		...
		function n(t, e, i) {
			...
			return u(o) ? (a = i > 0 ? "top" : "bottom", n = "center") : u(o - c) ? (a = i > 0 ? "bottom" : "top", n = "center") : (a = "middle", n = o > 0 && c > o ? i > 0 ? "right" : "left" : i > 0 ? "left" : "right"), {
				rotation: o,
				textAlign: n,
				verticalAlign: a
			}
		...
		function a(t, e, i) {
			var n, a, o = h(-t.rotation),
				r = i[0] > i[1],
				s = "start" === e && !r || "start" !== e && r;
			return u(o - c / 2) ? (a = s ? "bottom" : "top", n = "center") : u(o - 1.5 * c) ? (a = s ? "top" : "bottom", n = "center") : (a = "middle", n = 1.5 * c > o && o > c / 2 ? s ? "left" : "right" : s ? "right" : "left"), {
				rotation: o,
				textAlign: n,
				verticalAlign: a
			}
		...
		var f = {
				...
				axisName: function() {
					...
					if (null == i && (i = e.get("name")), i) {
						var o, s = e.get("nameLocation"),
							l = t.nameDirection,
							h = e.getModel("nameTextStyle"),
							u = e.get("nameGap") || 0,
							c = this.axisModel.axis.getExtent(),
							d = c[0] > c[1] ? -1 : 1,
							f = ["start" === s ? c[0] - d * u : "end" === s ? c[1] + d * u : (c[0] + c[1]) / 2, "middle" === s ? t.labelOffset + l * u : 0];
						o = "middle" === s ? n(t, t.rotation, l) : a(t, s, c), this.group.add(new r.Text({
							style: {
								text: i,
								textFont: h.getFont(),
		...
		function s(t, e, i, n, a) {
			var r = t.length;
			if (1 == a)
				for (var s = 0; r > s; s++) n[s] = o(t[s], e[s], i);
			else
				for (var l = t[0].length, s = 0; r > s; s++)
					for (var h = 0; l > h; h++) n[s][h] = o(t[s][h], e[s][h], i)
		}
		...
		function l(t, e, i) {
			...
			if (n !== a) {
				...
				if (o) t.length = a;
					...
					for (var r = n; a > r; r++) t.push(1 === i ? e[r] : x.call(e[r]))
			}
		}
		...
		function u(t, e, i, n, a, o, r, s, l) {
			var h = t.length;
			if (1 == l)
				for (var u = 0; h > u; u++) s[u] = c(t[u], e[u], i[u], n[u], a, o, r);
			else
				for (var d = t[0].length, u = 0; h > u; u++)
					for (var f = 0; d > f; f++) s[u][f] = c(t[u][f], e[u][f], i[u][f], n[u][f], a, o, r)
		}
			...
			if (x) {
				...
				if (!L) {
					...
					var H = function(t, e) {
							...
							if (0 !== n)
								if (E = (e - I[i]) / n, v)
									if (V = T[i], O = T[0 === i ? i : i - 1], N = T[i > x - 2 ? x - 1 : i + 1], B = T[i > x - 3 ? x - 1 : i + 2], b) u(O, V, N, B, E, E * E, E * E * E, d(t, a), A);
									else {
										var l;
										if (M) l = u(O, V, N, B, E, E * E, E * E * E, W, 1), l = f(W);
										else {
											if (S) return r(V, N, E);
							...
							else if (b) s(T[i], T[i + 1], E, d(t, a), A);
							else {
								var l;
								if (M) s(T[i], T[i + 1], E, W, 1), l = f(W);
								else {
		...
		var a = i(58),
			...
			c = {},
			d = {};
		d.version = "3.0.7", d.init = function(t, e) {
			var i = new f(a(), t, e);
			return c[i.id] = i, i
		...
		function r(t) {
			return {
				applyVisual: function(e, i, n) {
					var a = i("color"),
						o = c.isArray(e);
					if (e = o ? [this.mapValueToVisual(e[0]), this.mapValueToVisual(e[1])] : this.mapValueToVisual(e), c.isArray(a))
						for (var r = 0, s = a.length; s > r; r++) a[r].color = t(a[r].color, o ? e[r] : e);
					else n("color", t(a, e))
				},
			...
			_updateStyle: function(t, e, i) {
				...
				e.eachItemGraphicEl(function(r, s) {
					var l = e.getItemModel(s),
						...
						d = l.getModel("itemStyle.emphasis").getBarItemStyle();
					r.setShape("r", c.get("barBorderRadius") || 0), r.setStyle(a.defaults({
						fill: h
					}, c.getBarItemStyle()));
		...
		function n(t, e, i, n, a, o, r) {
			function s(e, i, n, a) {
				for (var o = e; i > o; o++)
					if (t[o].y += n, o > e && i > o + 1 && t[o + 1].y > t[o].y + t[o].height) return void l(o, n / 2);
				l(i - 1, n / 2)
			}
		...
		function n(t) {
			...
			e && a.each(o, function(i) {
				var n = e.normal,
					o = e.emphasis;
				n && n[i] && (t[i] = t[i] || {}, t[i].normal ? a.merge(t[i].normal, n[i]) : t[i].normal = n[i], n[i] = null), o && o[i] && (t[i] = t[i] || {}, t[i].emphasis ? a.merge(t[i].emphasis, o[i]) : t[i].emphasis = o[i],
					o[i] = null)
			})
		}
		var a = i(1),
		...
		t.exports = function(t) {
			if (t) {
				...
				if (e) {
					...
					var o = t.markPoint;
					if (o && o.data)
						for (var r = o.data, i = 0; i < r.length; i++) n(r[i]);
					var s = t.markLine;
					if (s && s.data)
						for (var l = s.data, i = 0; i < l.length; i++) a.isArray(l[i]) ? (n(l[i][0]), n(l[i][1])) : n(l[i])
				}
			}
		}
	}, function(t, e) {
		...
		A.prototype = {
			...
			findHover: function(t, e, i) {
				for (var n = this.storage.getDisplayList(), a = n.length - 1; a >= 0; a--)
					if (!n[a].silent && n[a] !== i && !n[a].ignore && r(n[a], t, e)) return n[a]
			}
		...
		var n = i(1),
			...
			r = i(56),
			s = function(t) {
				t = t || {}, this.stage = t.stage || {}, this.onframe = t.onframe || function() {}, this._clips = [], this._running = !1, this._time = 0, a.call(this)
			};
		s.prototype = {
			constructor: s,
			addClip: function(t) {
		...
		h.prototype = {
			...
			_animateToShallow: function(t, e, i, n, o) {
				var r = {},
					l = 0;
				for (var h in i)
					if (null != e[h]) s(i[h]) && !a.isArrayLike(i[h]) ? this._animateToShallow(t ? t + "." + h : h, e[h], i[h], n, o) : (r[h] = i[h], l++);
					else if (null != i[h])
					if (t) {
						var u = {};
		...
		i(2).extendComponentView({
			...
			_hide: function() {
				this._hideAxisPointer(), this._resetLastHover(), this._alwaysShowContent || this._tooltipContent.hideLater(this._tooltipModel.get("hideDelay")), this._api.dispatchAction({
					type: "hideTip",
					from: this.uid
				})
			},
						...
						switch (a = t[r++], n = "", i = 0, a) {
							...
							case d:
								...
								var F = t[r++],
									...
									I = E + x(B) * V,
									Z = F ? " wa " : " at ";
								Math.abs(W - M) < 1e-10 && F && (W += 270 / S), p.push(Z, g(((R - O) * P + L) * S - A), b, g(((E - V) * k + D) * S - A), b, g(((R + O) * P + L) * S - A), b, g(((E + V) * k + D) * S - A), b, g((W * P + L) * S - A), b, g((H * k + D) * S - A), b, g((M * P + L) * S - A), b, g((I * k + D) * S - A)), s = M, l = I;
								break;
							case o.R:
								var q = G[0],
									j = G[1];
			...
			contain: function(t) {
				...
				if (e.contain(t[0], t[1]))
					for (var n = 0, o = i.length; o > n; n++)
						if (a.contain(i[n], t[0], t[1])) return !0;
				return !1
			},
			transformTo: function(t, e, i, n) {
				var a = this.getBoundingRect(),
		...
		s.updateData = function(t, e, i) {
			...
			n.setStyle(r.defaults({
				fill: d
			}, c.getModel("normal").getItemStyle())), n.hoverStyle = c.getModel("emphasis").getItemStyle(), this._updateLabel(t, e), o.setHoverStyle(this)
		...
		function x(t, e) {
			...
			if (1 === arguments.length)
				for (; ++o < a;) i = +t[o], isNaN(i) || (n += i);
			else
				for (; ++o < a;) i = +e.call(t, t[o], o), isNaN(i) || (n += i);
			return n
		}
					...
					if (!A || !A.length) {
						...
						if (T) {
							var C = Math.max(_ - 2 * I, 0),
								...
								R = P.getTextRect(z),
								E = D.get("show");
							!E || R.height > L ? z = "" : R.width > C && (z = P.get("ellipsis") ? P.ellipsis(z, C) : ""), o.setHoverStyle(T, k), T.dataIndex = l.dataIndex, T.seriesIndex = this.seriesModel.seriesIndex, T.culling = !0, T.setShape({
								x: I,
								y: I,
								width: C,
								height: L
		...
		for (var n = i(220), a = [126, 25], o = [
			...
			for (var s = 0; s < o[r].length; s++) o[r][s][0] /= 10.5, o[r][s][1] /= -14, o[r][s][0] += a[0], o[r][s][1] += a[1];
		t.exports = function(t) {
		...
		u.prototype = {
			...
			function o(t, e) {
				...
				var n = t.children;
				if (n)
					for (var s = 0; s < n.length; s++) o(n[s], i)
			}
			var r = new n(e, i),
				c = [];
